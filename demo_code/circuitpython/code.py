...
try:
    ...
    from edu_pico_lib import edu_paj7620_proximity
    from edu_pico_lib import edu_opt4048_light
    from edu_pico_lib import edu_paj7620_gesture
    from edu_pico_lib import edu_opt4048_colour
...
def init_module(module):
    ...
    if module == 1:
       edu_buttons.init_module(oled)
        ...
        edu_paj7620_proximity.init_module(i2c)
    elif module == 5:
        edu_opt4048_light.init_module(i2c)
    elif module == 6:
        edu_paj7620_gesture.init_module(i2c)
    elif module == 7:
        edu_opt4048_colour.init_module(i2c)
    elif module == 8:
...
def deinit_module(module):
    if module == 1:
       # No need to deinit buttons
        ...
        edu_paj7620_proximity.deinit_module()
    elif module == 5:
        edu_opt4048_light.deinit_module()
    elif module == 6:
        edu_paj7620_gesture.deinit_module()
    elif module == 7:
        edu_opt4048_colour.deinit_module()
    elif module == 8:
...
try:
    ...
    while True:
        ...
        if module == 1:
            ...
            edu_paj7620_proximity.run_module(0.8, oled)
        elif module == 5:
            edu_opt4048_light.run_module(1, oled)
        elif module == 6:
            edu_paj7620_gesture.run_module(0.05, oled)
        elif module == 7:
            edu_opt4048_colour.run_module(1, oled)
        elif module == 8:
